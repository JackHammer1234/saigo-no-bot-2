...
const recompensasBase = [
  // Comunes
  { nombre: "Pergamino: Técnica Menor", descripcion: "Un pergamino medio meh pero útil.", rareza: "comun", peso: 50 },
  ...
  // Épicas
  { nombre: "Kinjutsu Mayor", descripcion: "Jutsu prohibido de verdad, aguas.", rareza: "epico", peso: 4 },
  { nombre: "Material Genético de Clan Poderoso", descripcion: "Células de alguien realmente roto.", rareza: "epico", peso: 4 },

  // Legendarias
  { nombre: "Reliquia Legendaria", descripcion: "Artefacto antiguísimo y OP.", rareza: "legendario", peso: 1 },
  { nombre: "Kekkei Genkai Raro", descripcion: "Algo que ni debería existir.", rareza: "legendario", peso: 1 },
];
